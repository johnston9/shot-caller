    ...
    <div className='mt-3'>
      ...
      <Row className='mt-3'>
          ...
          <Button onClick={() => history.push("crewinfo/edit/1")}
            className={`px-5 ${btnStyles.Button} ${btnStyles.CrewEdit}`}>
            Edit Info</Button>
          </Col>
        </Row>
        <div className='mt-3'>
        <Row className={`${styles.ButtonLine} mt-0`}>
            ...
            <Row className={`${styles.ButtonLine} text-center mt-0`}>
              <Col xs={4} md={2} className='py-0'>
                  <p
                    className={`py-0 mb-0 ${styles.Button}`}
                    onClick={() => setShowEle(showEle => !showEle)} > Electric
                  </p>
              </Col>
              <Col xs={4} md={2} className='py-0'>
                      <p
              ...
              <Col xs={4} className='mx-0 px-0 py-0' md={2}>
                <p
                    className={`py-0 mb-0 ${styles.Button}`}
                    onClick={() => setShowSou(showSou => !showSou)} > Sound/Additional
                </p>
              </Col>
              ...
              <Col xs={4} className='mx-0 px-0 py-0' md={2}>
                <p
                    className={`py-0 mb-0 ${styles.Button}`}
                    onClick={() => setShowPos(showPos => !showPos)} > Post/Transport
                </p>
              </Col>
            </Row>  
        ...
        {!showCom ? (
                ...
                <InfoCompany crewInfoOne={crewInfoOne} setShowPro={setShowPro} /> 
                ) } 
        {/* InfoProduction */}
        {!showPro ? (
                ""
