...
const CrewStunts = ({handleChange, postData, setShow}) => {
  ...
  return (
    <div className="pb-3 text-center">
      ...
      <h5 className={`pl-5 mb-0 text-center py-1 ${styles.Bold }`} >STUNTS/SFX DEPARTMENTS </h5>
      </div>
      ...
      <div>
      <p className={`my-3 py-0 mx-md-4 ${styles.SubTitle }` } 
      style={{ textTransform: 'uppercase'}}>Stunt Performer 3</p> 
      <div>
      <span className={`py-1 px-3 px-md-5 ${styles.BoldTitleCall }`} >
      ...
      <div>
      <p className={`my-3 py-0 mx-md-4 ${styles.SubTitle }` } 
      style={{ textTransform: 'uppercase'}}>Stunt Performer 4</p> 
      <div>
      <span className={`py-1 px-3 px-md-5 ${styles.BoldTitleCall }`} >
      ...
      <div>
      <p className={`my-3 py-0 mx-md-4 ${styles.SubTitle }` } 
      style={{ textTransform: 'uppercase'}}>Stunt Performer 5</p> 
      <div>
      <span className={`py-1 px-3 px-md-5 ${styles.BoldTitleCall }`} >
      ...
      {/* SFX */}
      <div>
      <h5 className={`mt-4 mb-0 py-1 ${styles.SubTitle }`} >SFX DEPARTMENT</h5> 
